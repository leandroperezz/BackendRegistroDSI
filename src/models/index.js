...
PostulacionPas.belongsTo(Estudiante, { foreignKey: 'estudianteId', as: 'sestudiante' });
...
PostulacionPas.belongsTo(Beca, { foreignKey: 'pasantiaId', as: 'pasantia' });



Beca.hasMany(PostulacionBeca, { foreignKey: 'becaId', as: 'applications' });
